...
// Declared in the header file, timlibc.h
...
//              *********************************** TIME2MDY *************************
PROCEDURE TIME2MDY(int REF MM, int REF DD, int REF YY) IS
...
// **************************************************** GetDateTime ***********************************
DateTimeType FUNCTION GetDateTime()  IS
  DateTimeType DateTime;
  time_t raw;
...
// ***************************************** MDY2STR ***************************************************
string FUNCTION MDY2STR(int M, int D, int Y, string REF MDYSTR) IS
...
// ************************************************ JULIAN **********************************
unsigned int FUNCTION JULIAN(int M, int D, int Y) IS
...
// **************************************** GREGORIAN ****************************************
PROCEDURE GREGORIAN(unsigned int Juldate,int REF M,int REF D,int REF Y) IS
