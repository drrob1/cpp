...
FUNCTION int main(argcargv) IS
  ...
  NOS = Student::noOfStudents;


  cout << "No of s1.students " << s1.noOfStudents << endl;
//  cout << "No of Student::students " << NOS << end;  // equivalent way to access the static data element.  Except that this line is giving an error of unknown type for << operator
